...
2. `git push` om je aangepaste geschiedenis (met onze recentste aanpassingen) naar jouw eigen Github repository door te sturen
3. `git pull` om zeker te zijn dat alles naar behoren gesynchroniseerd is
